        ...
        try {
            const response = await fetch('https://api.openai.com/v1/chat/completions', {
                ...
                headers: {
                    ...
                    'Authorization': `Bearer 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`
                },
                body: JSON.stringify({
                    model: "gpt-4o-mini",
                    messages: [{
